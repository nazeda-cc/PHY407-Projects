"""
This module contains one function for trapezoid rule, one for Simpson's rule,
and a few about Gaussian quadrature
Author: Nicolas Grisouard, Univ. Toronto, 2020
"""
import numpy as np
