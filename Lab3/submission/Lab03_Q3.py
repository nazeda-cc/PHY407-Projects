...
#target file name
file = 'N46E006.hgt'
#define h for gradient calculation
h = 420
#Coordinates of locations to be zoomed in
geneva = [46.2, 6.12]
cern = [46.25, 6.06]
Lausanne = [46.52, 6.61]
evian = [46.4, 6.59]
...
##################### Generate the relie map ########################
phi = np.pi / 6         #Define the incoming light's angle
